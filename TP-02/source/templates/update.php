<?php
    ...
    $dbb = new Model\Model();
$userInfo = Model\Model::getUserInfos($dbb,$_SESSION['user_id']);
?>
...
<main>
    <section>
        ...
        <form action="index.php?action=update" method="post">
            ...
            <input type="text" id="nom" name="nom" value="<?= Security\SecurityFunctions::sanitizeInput($userInfo['nom']); ?>" required>
            <?php if (isset($data['errors']['nom'])) : ?>
                <p class="error-message"><?php echo $data['errors']['nom']; ?></p>
            <?php endif; ?>
            <label for="prenom">Prénom:</label>
            <input type="text" id="prenom" name="prenom" value="<?= Security\SecurityFunctions::sanitizeInput($userInfo['prenom']); ?>" required>
            <?php if (isset($data['errors']['prenom'])) : ?>
                <p class="error-message"><?php echo $data['errors']['prenom']; ?></p>
            <?php endif; ?>
            <label for="adresse">Adresse:</label>
            <input type="text" id="adresse" name="adresse" required value="<?= Security\SecurityFunctions::sanitizeInput($userInfo['adresse']); ?>" required>
            <?php if (isset($data['errors']['adresse'])) : ?>
                <p class="error-message"><?php echo $data['errors']['adresse']; ?></p>
            <?php endif; ?>
            <label for="email">Email:</label>
            <input type="email" id="email" name="email" value="<?= Security\SecurityFunctions::sanitizeInput($userInfo['email']); ?>" required>
